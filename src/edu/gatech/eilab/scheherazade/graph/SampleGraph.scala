...
object SampleGraph {
  ...
  def sample7: Graph =
    {
      ...
      val me = List(
        new MutualExcl(c1, c8),
        new MutualExcl(c3, c5),
        new MutualExcl(c5, c9),
        new MutualExcl(c5, c7))
  ...
  def sample8: Graph =
    {
      ...
      val me = List(
        new MutualExcl(c4, c9),
        new MutualExcl(c3, c2),
        new MutualExcl(c2, c6),
        new MutualExcl(c6, c9))
  ...
  def sample18: Graph =
    {
      ...
      val links = List(
        ...
        new Link(c2, c3),
        new Link(c2, c4),
        new Link(c2, c7), // c2->c7 creating error 
        new Link(c3, c5),
        new Link(c3, c8),
        new Link(c3, c9),
        new Link(c4, c6),
  ...
  def sample19: Graph =
    {
      ...
      val me = List(
        new MutualExcl(c6, c5),
        new MutualExcl(c7, c8),
        new MutualExcl(c10, c7),
        new MutualExcl(c1, c9))
  ...
  def sample26: Graph =
    {
      ...
      val me = List(
        new MutualExcl(c1, c10),
        new MutualExcl(c2, c7),
        new MutualExcl(c4, c5),
        new MutualExcl(c7, c9))
  ...
  def sample28: Graph =
    {
      ...
      val me = List(
        new MutualExcl(c1, c5),
        new MutualExcl(c4, c8),
        new MutualExcl(c6, c7),
        new MutualExcl(c8, c7))
  ...
  def sample32: Graph =
    {
      ...
      val c9 = new Cluster("C9", Nil)
      val c5 = new Cluster("C5", Nil)
      val nodes = List(c1, c7, c4, c2, c10, c8, c6, c3, c9, c5)
  ...
  def sample33: Graph =
    {
      ...
      val c6 = new Cluster("C6", Nil)
      val c7 = new Cluster("C7", Nil)
      val nodes = List(c5, c10, c8, c9, c4, c1, c3, c2, c6, c7)
      val links = List(
        new Link(c9, c10),
        new Link(c5, c6),
        new Link(c6, c8),
  ...
  def sample34: Graph =
    {
      ...
      val c5 = new Cluster("C5", Nil)
      val c4 = new Cluster("C4", Nil)
      val nodes = List(c8, c9, c7, c10, c3, c6, c1, c2, c5, c4)
      val links = List(
        new Link(c9, c10),
        new Link(c5, c7),
        new Link(c7, c8),
  ...
  def sample35: Graph =
    {
      // I suppose you cannot create a link from C4 to C8
      val c4 = new Cluster("C4", Nil)
      val c6 = new Cluster("C6", Nil)
      val c1 = new Cluster("C1", Nil)
      val c10 = new Cluster("C10", Nil)
      ...
      val c2 = new Cluster("C2", Nil)
      val c3 = new Cluster("C3", Nil)
      val nodes = List(c4, c6, c1, c10, c5, c9, c7, c8, c2, c3)
      val links = List(
        new Link(c9, c10),
        new Link(c5, c7),
        new Link(c7, c8),
  ...
  def sample36: Graph =
    {
      ...
      val c6 = new Cluster("C6", Nil)
      val c9 = new Cluster("C9", Nil)
      val nodes = List(c5, c8, c1, c7, c2, c4, c10, c3, c6, c9)
      val links = List(
        new Link(c8, c10),
        new Link(c5, c6),
        new Link(c5, c7),
