...
package graph {
  ...
  /** Generates graphs for all combinations of parameters
   * 
   */
  object SweepingGraphGen {
    ...
    /** Generates graphs according to a meta-configuration file
     *  All combinations of supplied parameters are used for graph generation
