...
object test {
  ...
  for(i <- 0 until 4; j <- 0 until 5)
  	m(i)(j) = i + j
  val matrix = new Matrix(m)                      //> matrix  : Jama.Matrix = Jama.Matrix@45d64c37
  ...
  val m2 = matrix.getMatrix(0, 0, 0, 4)           //> m2  : Jama.Matrix = Jama.Matrix@7825d2b2
  m2.print(5, 3)                                  //> 
                                                  //|   0.000  1.000  2.000  3.000  4.000
                                                  //| 
	m2.getColumnPackedCopy()                  //> res4: Array[Double] = Array(0.0, 1.0, 2.0, 3.0, 4.0)
	
	val a = 1.0                               //> a  : Double = 1.0
	(a*10).toInt                              //> res5: Int = 10
